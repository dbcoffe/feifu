...
$(".chooseGoodMorePtwo span")[0].innerText="约 17 x 5 cm";
$(".chooseGoodMorePthree span")[0].innerText="约280g";
...
$(".chooseGood>button:nth-child(2)").click(function () {
    ...
    $(".chooseGoodMorePtwo span")[0].innerText="约 17 x 9 cm";
    $(".chooseGoodMorePthree span")[0].innerText="约560g";
    $(this).css("background","#cea461");
    $(this).siblings().css("background","#e4dbcd");
});
// 点击第三个按钮
